...
CLOUDINARY_STORAGE_URL = os.getenv('CLOUDINARY_STORAGE_URL')    

DEFAULT_FILE_STORAGE = 'cloudinary_storage.storage.MediaCloudinaryStorage'  # Ensure this is set properly

CLOUDINARY_STORAGE_RESOURCE_TYPE = "image"
...
ALLOWED_HOSTS = os.getenv('DJANGO_ALLOWED_HOSTS', 'ALLOWED_HOSTS = ['arika-edtech.onrender.com', 'localhost', '127.0.0.1']
').split(',')
